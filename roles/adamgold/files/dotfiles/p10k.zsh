# Generated by Powerlevel10k configuration wizard on 2020-02-09 at 15:26 IST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 65366.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow,
# slanted separators, slanted heads, round tails, 2 lines, solid, no frame,
# lightest-ornaments, sparse, few icons, fluent, transient_prompt, instant_prompt=off.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    custom_kube_ps1         # Kubernetes prompt
